...
let initialProducts = [
  ...
  { id: 12, name: 'Product 12', category: 'Category A', price: 20.99, stockQuantity: 1 },
  { id: 13, name: 'Product 13', category: 'Category c', price: 25.30, stockQuantity: 9 },
  { id: 14, name: 'Product 14', category: 'Category e', price: 19.99, stockQuantity: 16 },
  { id: 15, name: 'Product 15', category: 'Category f', price: 17.30, stockQuantity: 20 },
];

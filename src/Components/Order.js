...
let initialOrders = [
  { id: 1, orderId: 'AY4489', customerName: 'Aman Yadav', orderDate: '2024-02-28', status: 'Delivered', expectedDeliveryDate: new Date() },
  { id: 2, orderId: 'KN6653', customerName: 'Kevin Nash', orderDate: '2024-03-08', status: 'Delivered', expectedDeliveryDate: new Date() },
  { id: 3, orderId: 'NP4696', customerName: 'Nikita Pawar', orderDate: '2024-03-11', status: 'Processing', expectedDeliveryDate: new Date() },
  
  { id: 4, orderId: 'RD9561', customerName: 'Rahul Deshmukh', orderDate: '2024-03-13', status: 'Processing', expectedDeliveryDate: new Date() },
  { id: 5, orderId: 'AT3246', customerName: 'Aman Thakur', orderDate: '2024-03-15', status: 'Pending', expectedDeliveryDate: new Date() },
  { id: 6, orderId: 'MS3468', customerName: 'Mohit Shah', orderDate: '2024-03-15', status: 'Pending', expectedDeliveryDate: new Date() }
];
  ...
  return (
    ...
    <div className="order-container">
      ...
      <div className="order-content">
         {selectedOrder && (
          <div id="order-details" className="order-details">
            <h3>Order Details</h3>
